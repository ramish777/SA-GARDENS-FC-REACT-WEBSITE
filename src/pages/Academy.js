    ...
    return (
        <div className="relative w-full min-h-screen bg-black">
                ...
                <div className="relative z-10 h-full overflow-y-auto">
                    ...
                    <div className="flex flex-col mt-20 md:flex-row justify-center md:mt-40 p-4">
                        <div className="w-full md:w-2/3 justify-center items-center">
                            <h1 className="text-2xl md:text-4xl sm:text-4xl font-bold text-white text-center">Academy</h1>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center md:mt-10 p-4">
                        <button className="bg-red-600 text-white md:w-1/3 font-bold py-3 px-6 rounded text-lg hover:bg-transparent hover:border-white hover:border-2 hover:text-white transition-colors duration-300"
            ...
            <div id="price" className="locations-section items-center justify-center bg-gray-700 py-16">
                <h2 className="text-3xl font-bold text-center text-white md:mb-4">Training Packages</h2>
                {/* <div className="h-2 rounded-lg w-64 bg-red-600 mx-auto"></div>  */}
                <div className="flex flex-col items-center justify-center p-4 md:ml-32 md:mr-32 md:mt-8">
            ...
            {/* Clubs and facilties */}
            <div id="facilities" className="flex flex-col md:flex-row p-4 bg-gray-800">
                <div className="flex flex-col w-full items-start md:ml-32 md:mr-32 md:mt-8 md:mb-8 p-4">
                    <div className="flex w-full items-center justify-between md:mr-8 sm:mr-8">
                        <div className="flex items-center">
                            ...
                            <h2 className="text-white text-xl md:text-2xl font-bold ml-4">Our Facilities and Activities</h2>
                        </div>
                    ...
                    <div className="mt-8">
                        <h3 className="text-white text-xl md:text-2xl font-bold">Exciting Facilities We Offer</h3>
            ...
            <div id="locations" className="locations-section items-center justify-center bg-gray-700 py-16">
                <h2 className="text-3xl font-bold text-center text-white md:mb-4">Our Locations</h2>
                {/* <div className="h-2 rounded-lg w-64 bg-red-600 mx-auto"></div>  */}
                <div className="flex flex-col items-center justify-center p-4 md:ml-32 md:mr-32 md:mt-8">
