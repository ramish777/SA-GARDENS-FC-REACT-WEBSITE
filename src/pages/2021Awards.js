        ...
        <div className="relative w-full min-h-screen bg-black">
                ...
                <div className="relative z-10 h-full overflow-y-auto">
                    ...
                    <div className="flex flex-col mt-20 md:flex-row justify-center md:mt-40 p-4">
                        <div className="w-full md:w-2/3 justify-center items-center">
                            <h1 className="text-2xl md:text-4xl sm:text-4xl font-bold text-white text-center">Achievements (2021-22)</h1>
            ...
            <div className="flex flex-col p-4 bg-gray-700">
                <div className="flex flex-col items-start md:ml-32 md:mt-8 p-4">
                    ...
                    <h2 className="text-white text-2xl font-bold ml-4">Futsal Fiesta</h2>
                    </div>
            ...
            <div className="flex flex-col p-4 bg-gray-700">
                <div className="flex flex-col items-start md:ml-32 md:mt-8 p-4">
                    <div className="flex items-center md:mr-8 sm:mr-8">
                    <div className="w-1.5 h-10 md:w-2.5 bg-red-600"></div>
                    <h2 className="text-white text-2xl font-bold ml-4">Liga Smurfia - Lahore</h2>
                    </div>
                    <div className="relative flex flex-col md:flex-row mt-8 md:mt-8 md:mr-32">
                        <div className="relative md:w-4/6">
                            <Carousel images={images} />
            ...
            {/* Liga Smurfia Islamabad */}
            <div className="flex flex-col p-4 bg-gray-700">
                <div className="flex flex-col items-start md:ml-32 md:mt-8 p-4">
                    <div className="flex items-center md:mr-8 sm:mr-8">
                    <div className="w-1.5 h-10 md:w-2.5 bg-red-600"></div>
                    <h2 className="text-white text-2xl font-bold ml-4">Liga Smurfia - Islamabad</h2>
                    </div>
                    <div className="relative flex flex-col md:flex-row mt-8 md:mt-8 md:mr-32">
                        <div className="relative md:w-4/6">
                            <Carousel images={images} />
            ...
            {/* Lahore Sports Tournament */}
            <div className="flex flex-col p-4 bg-gray-700">
                <div className="flex flex-col items-start md:ml-32 md:mt-8 p-4">
                    <div className="flex items-center md:mr-8 sm:mr-8">
                    <div className="w-1.5 h-10 md:w-2.5 bg-red-600"></div>
                    <h2 className="text-white text-2xl font-bold ml-4">Lahore Sports Tournament</h2>
                    </div>
                    <div className="relative flex flex-col md:flex-row mt-8 md:mt-8 md:mr-32">
                        <div className="relative md:w-4/6">
                            <Carousel images={images} />
